...
export const printers = [
  { id: 1, name: 'Máy in 1', location: 'Tầng 1', fileType: ['PDF', 'DOCX', 'JPEG'], status: 'Sẵn sàng' },
  ...
  { id: 4, name: 'Máy in 4', location: 'Tầng 4', fileType: ['PDF', 'DOCX', 'JPEG'], status: 'Sẵn sàng' },
  { id: 6, name: 'Máy in 5', location: 'Tầng 5', fileType: ['PDF', 'DOCX'], status: 'Sẵn sàng' },
  { id: 7, name: 'Máy in 1', location: 'Tầng 1', fileType: ['PDF', 'DOCX', 'JPEG'], status: 'Sẵn sàng' },
